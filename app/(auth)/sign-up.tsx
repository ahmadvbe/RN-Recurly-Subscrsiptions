...
const SignUp = () => {
    ...
    const handleSubmit = async () => {
        ...
        //extra step comparing to sign-in
        // Send verification email - after the user submit their email and password =>the screen then transition to a code input view 2:41:47
        if (!error) {
            await signUp.verifications.sendEmailCode();
        }
    };

    const handleVerify = async () => {//=>the screen then transition to a code input view 2:41:47
                             ...
                             <View className="auth-card">
                                 <View className="auth-form">
                                    ...
                                    <Pressable
                                        ...
                                        onPress={handleVerify} ////=>the screen then transition to a code input view 2:41:47
